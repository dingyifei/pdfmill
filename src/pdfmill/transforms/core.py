"""Core PDF transformation functions.

These functions perform the actual PDF manipulations using pypdf.
They are wrapped by TransformHandler implementations for the registry pattern.
"""
